...
graph TB
    subgraph Domain["🎯 DOMAIN LAYER"]
        ...
        D1 -.->|emite| E1[Domain Events in-memory]
        D2 -.->|emite| E1
        D3 -.->|emite| E1
    end
    
    subgraph Application["💼 APPLICATION LAYER"]
        A1[TransactionService]
        A2[AntiFraudService]
        A3[AuthService]
        A5[EventDispatcher]
    ...
    subgraph Infrastructure["🔧 INFRASTRUCTURE LAYER"]
        I1[MdcFilter]
        I2[RequestLoggingFilter]
        I3[RabbitEventPublisher]
        I4[DomainEventLogger]
        I5[UserContextEnricher]
    end
